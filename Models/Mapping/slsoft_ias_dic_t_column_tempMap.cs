...
{
    public class slsoft_ias_dic_t_column_tempMap : EntityTypeConfiguration<slsoft_ias_dic_t_column_temp>
    {
        public slsoft_ias_dic_t_column_tempMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("slsoft_ias_dic_t_column_temp", "slsoft_iasdb");

...
{
    public class slsoft_ias_bus_t_accesslistMap : EntityTypeConfiguration<slsoft_ias_bus_t_accesslist>
    {
        public slsoft_ias_bus_t_accesslistMap()
        {
            // Primary Key
            ...
            this.ToTable("slsoft_ias_bus_t_accesslist", "slsoft_iasdb");
            ...
            this.Property(t => t.Session_Code).HasColumnName("Session_Code");
            ...
            this.Property(t => t.LengthOfPage).HasColumnName("LengthOfPage");
